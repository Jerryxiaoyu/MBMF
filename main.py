...
def main():
    ...
    parser.add_argument('--env_name', type=str, default='Ant-v1')  #HalfCheetah-v2
    ...
    parser.add_argument('--onpol_iters', '-n', type=int, default=5)  # Aggregation iters  5
    parser.add_argument('--dyn_iters', '-nd', type=int, default=50)  # epochs
    ...
    parser.add_argument('--simulated_paths', '-sp', type=int, default=100)  # mpc  candidate  K 100
